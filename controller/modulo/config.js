...
const ERRO_USUARIO_DESATIVADO = {status: 409, message: 'USUARIO DESATIVADO'}
...
const SUCCESS_USUARIO_DESATIVADO = {status: 200, message: 'USUARIO DESATIVADO COM SUCESSO'}
